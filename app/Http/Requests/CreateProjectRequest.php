...
class CreateProjectRequest extends Request {
	...
	public function rules()
	{
		return [
            ...
            'full_desc'     => 'required',
            'target_amount' => 'required|integer|min:500',
            ...
            'main_img'      => 'required_without:mainImage|mimes:jpg,jpeg,png,bmp,tiff',
            'img_2'         => 'mimes:jpg,jpeg,png,bmp,tiff',
            'img_3'         => 'mimes:jpg,jpeg,png,bmp,tiff',
            'img_4'         => 'mimes:jpg,jpeg,png,bmp,tiff',
            'doc_1_mand'    => 'required_without:doc1Mand|mimes:jpg,jpeg,png,bmp,tiff,pdf',
            'doc_2_mand'    => 'required_without:doc2Mand|mimes:jpg,jpeg,png,bmp,tiff,pdf',
