<div class="row">
        ...
        <div class="row form-group">
            <div class="col-md-12 col-sm-12">
                ...
                @if($user == null)
                {!! Form::text('street', null, ['class' => 'form-input form-input-disabled', 'readonly' => 'readonly']) !!}
                @else
                {!! Form::text('street', $user->street, ['class' => 'form-input form-input-disabled', 'readonly' => 'readonly']) !!}
                @endif
            </div>
            <div class="col-md-12 col-sm-12">
        ...
        <div class="row form-group">
            <div class="col-md-6 col-sm-6">
                ...
                @if($user == null)
                {!! Form::text('postcode', null, ['class' => 'form-input form-input-disabled', 'readonly' => 'readonly']) !!}
                @else
                {!! Form::text('postcode', $user->postcode, ['class' => 'form-input form-input-disabled', 'readonly' => 'readonly']) !!}
                @endif
            ...
            <div class="col-md-6 col-sm-6 form-pair">
                ...
                @if($user == null)
                {!! Form::text('city', null, ['class' => 'form-input form-input-disabled', 'readonly' => 'readonly']) !!}
                @else
                {!! Form::text('city', $user->city, ['class' => 'form-input form-input-disabled', 'readonly' => 'readonly']) !!}
                @endif
