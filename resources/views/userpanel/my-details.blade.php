    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12">
            <div class="row-fluid clearfix">
                ...
                <a href="{{ action('UserpanelController@delete', $user->user_name) }}" id="forgot-my-password" class="col-xs-12 col-sm-5 col-md-5 pull-right btn login-submit mt-1em text-center">{{ trans('userpanel.delete-account') }}</a>
            </div>
        </div>
        <!-- end submit buttons -->
    </div>
