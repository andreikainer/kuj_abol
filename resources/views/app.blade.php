                            ...
                            <div>
                                ...
                                <!-- if there is a logged in user in the session, change the buttons to LOGOUT and USERNAME -->
                                    @if(Session::has('username'))
                                        ...
                                        <a href="{{ action('UserpanelController@index', Session::get('username')) }}" type="button" class="btn btn-xs button-main button-user" id="username-btn">{{ ucfirst(Session::get('username')) }}</a>
                                    @else
