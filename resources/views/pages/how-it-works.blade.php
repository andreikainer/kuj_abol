...
<!-- Tips for success grafics-->
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-0 border-thin">
...
<!-- About us -->
                <div class="row" id="about_us">
                    <div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2 text-center mt-3em mb-1em">
                        <h2 class="heading" >{{ trans('app.about-us') }}</h2>
                    </div>
                </div>
...
<!-- Our team -->
                <div class="row mb-1em" id="team">
                    <div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2 text-center mt-3em mb-1em">
                        <h2 class="heading">{{ trans('app.our-team') }}</h2>
                    </div>
                </div>
                ...
                <div class="row form-element text-center">
                    <div class="col-md-4 xs-mt">
                       ...
                       <p class="team"><i class="fa fa-envelope"></i><a href="{{ action('ContactFormController@getContactForm', array('address' => 'andrei@kinderfoerderungen.at', 'addressee' => 'Andreas Huber')) }}"> andreas@kinderfoerderungen.at</a></p>
                    </div>
                    <div class="col-md-4 xs-mt">
                    ...
                    <div class="col-md-4 col-md-offset-4 xs-mt">
                        <p class="btn blue_btn"><i class="fa fa-paper-plane"></i><a style="color:white; text-decoration:none" href="{{ action('ContactFormController@getContactForm') }}"> {{ trans('app.contact-form') }}</a></p>
                    </div>
                </div>
            </div>
            ...
            <div class="hidden-xs hidden-sm col-md-2 col-md-push-10 add-nav">
                <div class="list-group">
                    <a href="#how-it-works" data-scroll class="list-group-item sidemenu-item"><i class="fa fa-compass"></i> {{ trans('app.overview') }}</a>
                    <a href="#faq" data-scroll class="list-group-item sidemenu-item"><i class="fa fa-comments-o"></i>FAQ</a>
                    <a href="#about_us" data-scroll class="list-group-item sidemenu-item"><i class="fa fa-life-ring"></i> {{ trans('app.about-us') }}</a>
                    <a href="#team" data-scroll class="list-group-item sidemenu-item"><i class="fa fa-group"></i> {{ trans('app.our-team') }}</a>
                </div>
            </div>
