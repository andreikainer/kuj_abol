    ...
    <div class="container-fluid" role="main" id="sponsors-page">
        ...
        @foreach($logos as $logo)
            <div class="col-xs-8 col-xs-offset-2 col-sm-4 col-sm-offset-0 col-md-3 img-responsive mb-1em">
                <div class="logo-name img-responsive text-center invisible">{{$logo->business_name}}</div>
                <img src="{{ asset('img/logos/' . $logo->logo) }}" class="img-responsive m0auto form-element" alt="{{ $logo->business_name }}">
            </div>
        @endforeach
                </div>
            </div>
