            ...
            <div class="row">
                ...
                <div class="col-xs-12 visible-xs">
                    <div class="col-xs-7 padding-none">
                        <div class="col-xs-4 text-center form-section-tab form-section-tab-border-left form-section-tab-active mobile-section-tab" data-section="0"><i class="fa fa-play fa-lg"></i></div>
                        <div class="col-xs-4 text-center form-section-tab mobile-section-tab" data-section="1"><i class="fa fa-edit fa-lg"></i></div>
