            ...
            <div class="row">
                ...
                <div class="col-md-12 hidden-sm hidden-xs">
                    <div class="col-md-7 padding-none">
                        <div class="col-md-4 text-center form-section-tab form-section-tab-border-left" data-section="0">{{ trans('create-project-form.start') }}</div>
                        <div class="col-md-4 text-center form-section-tab form-section-tab-active" data-section="1">{{ trans('create-project-form.project-details') }}</div>
                ...
                <div class="col-sm-12 col-xs-12 visible-sm visible-xs">
                    <div class="col-sm-7 col-xs-7 padding-none">
                        <div class="col-sm-4 col-xs-4 text-center form-section-tab form-section-tab-border-left mobile-section-tab" data-section="0"><i class="fa fa-play fa-lg"></i></div>
                        <div class="col-sm-4 col-xs-4 text-center form-section-tab mobile-section-tab form-section-tab-active" data-section="1"><i class="fa fa-edit fa-lg"></i></div>
